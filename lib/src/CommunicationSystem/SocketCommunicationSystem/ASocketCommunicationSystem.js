...
var ASocketCommunicationSystem = function () {
  ...
  (0, _createClass3.default)(ASocketCommunicationSystem, [{
    ...
    value: function getSocket() {
      throw new _Errors2.default('Unimplemented getSocket methods in ' + _Utils2.default.getFunctionName() + ' child');
    }
    ...
    value: function sendMessage() {
      throw new _Errors2.default('EXXXX', 'Unimplemented sendMessage methods in ' + _Utils2.default.getFunctionName() + ' child');
    }
