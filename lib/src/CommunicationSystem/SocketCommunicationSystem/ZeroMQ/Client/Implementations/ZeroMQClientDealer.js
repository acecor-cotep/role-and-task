...
// Imports
var AZeroMQClient_js_1 = __importDefault(require("../AZeroMQClient.js"));
    ...
    ZeroMQClientDealer.prototype.start = function (_a) {
        ...
        return PromiseCommandPattern_js_1.default({
            func: function () { return _this.startClient({
                ...
                socketType: CONSTANT_js_1.default.ZERO_MQ.SOCKET_TYPE.OMQ_DEALER,
            }); },
        });
    };
