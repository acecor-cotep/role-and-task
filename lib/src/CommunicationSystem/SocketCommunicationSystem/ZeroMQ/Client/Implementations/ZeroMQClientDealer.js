...
var _AZeroMQClient2 = _interopRequireDefault(require("../AZeroMQClient.js"));
 ...
 *
 */
var ZeroMQClientDealer =
/*#__PURE__*/
function (_AZeroMQClient) {
  (0, _inherits2["default"])(ZeroMQClientDealer, _AZeroMQClient);

  function ZeroMQClientDealer() {
    (0, _classCallCheck2["default"])(this, ZeroMQClientDealer);
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ZeroMQClientDealer).apply(this, arguments));
  }

  (0, _createClass2["default"])(ZeroMQClientDealer, [{
    key: "start",
      ...
      return new _PromiseCommandPattern["default"]({
        func: function func() {
          return _this.startClient({
            ...
            socketType: _CONSTANT["default"].ZERO_MQ.SOCKET_TYPE.OMQ_DEALER
          });
        }
      });
    }
