      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            if (!check) return reject(new _Errors2.default('E2008', 'socketType: ' + socketType));
            ...
            return _this2.socket.bind(transport + '://' + ipServer + ':' + portServer, function (err) {
              if (err) {
                ...
                // Return an error
                return reject(new _Errors2.default('E2007', 'Specific: ' + err));
              }
        ...
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            _this3.socket.on(_CONSTANT2.default.ZERO_MQ.KEYWORDS_OMQ.CLOSE_ERROR, function (err, ep) {
              return reject(new _Errors2.default('E2006', 'Endpoint: ' + String(err) + ' ' + ep));
            });
