...
var AZeroMQServerLight = /** @class */ (function (_super) {
    ...
    AZeroMQServerLight.prototype.treatMessageFromClient = function () {
        ...
        this.socket.on(CONSTANT_js_1.default.ZERO_MQ.KEYWORDS_OMQ.MESSAGE, function (msg) {
            ...
            // Special handler for the pings, the pings will makes sure that the zeromq connection is still working
            // After Xs without any news from the client, we consider the client disconnected and throw an error
            if (msg === CONSTANT_js_1.default.ZERO_MQ.CLIENT_MESSAGE.ALIVE) {
                return;
            }
