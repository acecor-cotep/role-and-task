...
var ZeroMQServerPull = /** @class */ (function (_super) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            this.zmqObject.events.on('close', function (data) {
                                ...
                                throw new Errors_js_1.default('E2011');
                            });
                            this.zmqObject.events.on('disconnect', function () {
                                if (_this.isClosing) {
                                    return;
                                }
                                console.error("ZeroMQServerPull :: got unexpected event disconnect");
                                throw new Errors_js_1.default('E2010', 'disconnect');
                            });
                            ...
                            this.zmqObject.events.on('unknown', function (data) {
                                ...
                                throw new Errors_js_1.default('E2010', 'unknown');
                            });
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
     ...
     */
    ZeroMQServerPull.prototype.treatMessageFromClient = function () {
        var _this = this;
        var func = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        console.error('PULL :: Catch error on the fly', err_2);
                        return [3 /*break*/, 4];
                    case 4:
