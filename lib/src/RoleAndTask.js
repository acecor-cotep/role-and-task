...
function () {
  ...
  function RoleAndTask() {
    ...
    this.masterMutexValidationFunctions = []; // Handle the signals
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    ...
                    return _context3.abrupt("return", role.displayMessage((0, _objectSpread2["default"])({}, param, {
                  ...
                  case 7:
                    newParam = (0, _objectSpread2["default"])({}, param, {
                      // Add the task who perform the display
                      from: RoleAndTask.getTheTaskWhoPerformTheDisplay(role),
                      time: Date.now()
                    });
