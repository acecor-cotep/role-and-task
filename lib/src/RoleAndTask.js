            ...
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            role = _a.sent();
                            if (!(role && role.id === CONSTANT_1.default.DEFAULT_ROLES.MASTER_ROLE.id)) return [3 /*break*/, 4];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (role === false || role.id !== CONSTANT_1.default.DEFAULT_ROLES.MASTER_ROLE.id) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            taskHandler = role.getTaskHandler();
                            if (!taskHandler) {
                                return [2 /*return*/];
                            }
