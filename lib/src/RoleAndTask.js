...
var RoleAndTask = function () {
  ...
  (0, _createClass3.default)(RoleAndTask, [{
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this.getSlaveNorMaster();

                  case 2:
                    role = _context.sent;
                    return _context.abrupt('return', role.takeMutex(id));
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt('return', new _PromiseCommandPattern2.default({
                  func: function () {
                      ...
                      return _regenerator2.default.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                              role = _context2.sent;
                              return _context2.abrupt('return', role.releaseMutex(id));
    ...
    value: function spreadStateToListener() {
      ...
      this.stateChangeCallbacks.forEach(function (_ref4) {
        var callback = _ref4.callback;

        (0, _setImmediate3.default)(function () {
          return callback(_this3.states.find(function (x) {
            return x.id === _this3.eliotState.id;
          }));
        }, 0);
      });
    }
    ...
    value: function lookAtEliotStateChangePipe() {
      var _this4 = this;
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    elementToTreat = _this4.getEliotStateChangeToTreat();
                  ...
                  case 3:
                    ...
                    if (!(elementToTreat.eliotState.id === _this4.eliotState.id)) {
                      _context4.next = 7;
                      break;
                    }
                    ...
                    return _context4.abrupt('return', _this4.eliotChangeElementGotTreated(elementToTreat));

                  case 7:
                    oldEliotState = _this4.eliotState;


                    _this4.eliotState = elementToTreat.eliotState;

                    _context4.prev = 9;
                    _context4.next = 12;
                    return _this4.getSlaveNorMaster();
                  ...
                  case 24:
                    ...
                    elementToTreat.reject(_context4.t0);
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    _context5.next = 4;
                    return _this5.roleHandler.getRole(possibilities[i]);
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return _Utils2.default.promiseCallUntilTrue({
            functionToCall: _this6.getActualRole,
            context: _this6,

            args: [_this6.roles.map(function (x) {
              return x.id;
            })]
          });
        }
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            _this7.eliotStateChangeWaitingList.push({
              resolve: resolve,
              reject: reject,
              eliotState: _this7.states.find(function (x) {
                return x.id === idEliotState;
              }),
              inProgress: false
            });

            _this7.lookAtEliotStateChangePipe();
          });
        }
      });
    }
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 3:
                    ...
                    return _context6.abrupt('return', role.displayMessage((0, _extends3.default)({}, param, {
                  ...
                  case 7:
                    ...
                    return _context6.abrupt('return', role.displayMessage(newParam));
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    _context7.prev = 1;
                    _context7.next = 4;
                    return _this9.getSlaveNorMaster();
                  ...
                  case 4:
                    ...
                    return _context7.abrupt('return', role.tellMasterErrorHappened(err));

                  case 7:
                    _context7.prev = 7;
                    _context7.next = 10;
                    return _this9.changeEliotState(_CONSTANT2.default.DEFAULT_STATES.ERROR.id);
                  ...
                  case 14:
                    ...
                    RoleAndTask.exitEliotMsg('Exit eliot unproper ERROR HAPPENED', err, _context7.t0);
                  ...
                  case 20:
                    ...
                    RoleAndTask.exitEliotMsg('Exit eliot unproper ERROR HAPPENED CATCH', err, _context7.t1);
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 8:
                    _context8.next = 10;
                    return _this10.changeEliotState(_CONSTANT2.default.DEFAULT_STATES.CLOSE.id);

                  case 10:
                    return _context8.abrupt('return', _this10.quit());
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    if (!(_this11.eliotState.id === _CONSTANT2.default.DEFAULT_STATES.LAUNCHING.id)) {
                      _context9.next = 3;
                      break;
                    }

                    _this11.displayMessage({
                  ...
                  case 3:
                    _context9.prev = 3;
                    _context9.next = 6;
                    return _this11.makeTheMasterToQuitEverySlaveAndTask();
                  ...
                  case 10:
                    ...
                    RoleAndTask.getInstance().errorHappened(_context9.t0);
          ...
          return _regenerator2.default.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  _context10.next = 2;
                  return _this12.getSlaveNorMaster();
                ...
                case 5:
                  ...
                  _this12.makeTheMasterToQuitTheWholeApp();
    ...
    value: function spreadDataToEveryLocalTask(_ref12) {
      var _this13 = this;

      var dataName = _ref12.dataName,
          data = _ref12.data,
          timestamp = _ref12.timestamp,
          limitToTaskList = _ref12.limitToTaskList;
              ...
              while (1) {
                switch (_context11.prev = _context11.next) {
                  case 0:
                    _context11.prev = 0;
                    _context11.next = 3;
                    return _this13.getSlaveNorMaster();
                  ...
                  case 7:
                    ...
                    _this13.errorHappened(_context11.t0);
            ...
            return _regenerator2.default.wrap(function _callee12$(_context12) {
              while (1) {
                switch (_context12.prev = _context12.next) {
                  case 0:
                    _context12.next = 2;
                    return _this14.getMasterRole();

                  case 2:
                    role = _context12.sent;
                    return _context12.abrupt('return', role.getFullSystemPids());
    ...
    value: function getMasterRole() {
      ...
      return new _PromiseCommandPattern2.default({
        func: function () {
          var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13() {
            var roleMaster;
            return _regenerator2.default.wrap(function _callee13$(_context13) {
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    _context13.next = 2;
                    return _this15.getRoleHandler().getRole(_CONSTANT2.default.DEFAULT_ROLES.MASTER_ROLE.id);

                  case 2:
                    roleMaster = _context13.sent;
                  ...
                  case 5:
                    return _context13.abrupt('return', roleMaster);
