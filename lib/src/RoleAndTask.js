    ...
    value: function spreadStateToListener() {
      ...
      this.stateChangeCallbacks.forEach(function (_ref4) {
        ...
        (0, _setImmediate3.default)(function () {
          return callback(_this4.states.find(function (x) {
            return x.id === _this4.programState.id;
          }));
        }, 0);
      });
    }
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    elementToTreat = _this5.getProgramStateChangeToTreat();
                  ...
                  case 3:
                    ...
                    if (!(elementToTreat.programState.id === _this5.programState.id)) {
                      _context4.next = 7;
                      break;
                    }
                    ...
                    return _context4.abrupt('return', _this5.programChangeElementGotTreated(elementToTreat));

                  case 7:
                    oldProgramState = _this5.programState;


                    _this5.programState = elementToTreat.programState;

                    _context4.prev = 9;
                    _context4.next = 12;
                    return _this5.getSlaveNorMaster();
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    _context5.next = 4;
                    return _this6.roleHandler.getRole(possibilities[i]);
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return _Utils2.default.promiseCallUntilTrue({
            functionToCall: _this7.getActualRole,
            context: _this7,

            args: [_this7.roles.map(function (x) {
              return x.id;
            })]
          });
        }
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            _this8.programStateChangeWaitingList.push({
              resolve: resolve,
              reject: reject,
              programState: _this8.states.find(function (x) {
                return x.id === idProgramState;
              }),
              inProgress: false
            });

            _this8.lookAtProgramStateChangePipe();
          });
        }
      });
    }
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 7:
                    _context7.prev = 7;
                    _context7.next = 10;
                    return _this10.changeProgramState(_CONSTANT2.default.DEFAULT_STATES.ERROR.id);

                  case 10:

                    // We did sent the message :)
                    // Display the error message
                    _this10.displayMessage({
                      str: String(err && err.stack || err),
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 8:
                    _context8.next = 10;
                    return _this11.changeProgramState(_CONSTANT2.default.DEFAULT_STATES.CLOSE.id);

                  case 10:
                    return _context8.abrupt('return', _this11.quit());
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    if (!(_this12.programState.id === _CONSTANT2.default.DEFAULT_STATES.LAUNCHING.id)) {
                      _context9.next = 3;
                      break;
                    }

                    _this12.displayMessage({
                  ...
                  case 3:
                    _context9.prev = 3;
                    _context9.next = 6;
                    return _this12.makeTheMasterToQuitEverySlaveAndTask();
            ...
            while (1) {
              switch (_context10.prev = _context10.next) {
                ...
                case 5:
                  ...
                  _this13.makeTheMasterToQuitTheWholeApp();
              ...
              while (1) {
                switch (_context11.prev = _context11.next) {
                  ...
                  case 7:
                    ...
                    _this14.errorHappened(_context11.t0);
            ...
            return _regenerator2.default.wrap(function _callee13$(_context13) {
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    _context13.next = 2;
                    return _this16.getRoleHandler().getRole(_CONSTANT2.default.DEFAULT_ROLES.MASTER_ROLE.id);
