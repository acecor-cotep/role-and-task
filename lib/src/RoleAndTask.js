...
var RoleAndTask = function () {
  ...
  function RoleAndTask() {
    ...
    this.eliotState = _CONSTANT2.default.ELIOT_STATE.LAUNCHING;
  ...
  (0, _createClass3.default)(RoleAndTask, [{
    ...
    value: function getEliotStateChangeToTreat() {
      ...
      this.eliotStateChangeWaitingList.some(function (x) {
        ...
        if (x.eliotState === _CONSTANT2.default.ELIOT_STATE.ERROR) {
          errorElement = x;
    ...
    key: 'getActualRole',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(possibilities, i) {
        var role;
    ...
    value: function changeEliotState(eliotState) {
      var _this = this;

      return new _promise2.default(function (resolve, reject) {
        // Push the order in the list of state change to perform
        _this.eliotStateChangeWaitingList.push({
          resolve: resolve,
          reject: reject,
        ...
        _this.lookAtEliotStateChangePipe();
      });
    }
    ...
    key: 'errorHappened',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(err) {
        var role;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 7:
                _context5.prev = 7;
                _context5.next = 10;
                return this.changeEliotState(_CONSTANT2.default.ELIOT_STATE.ERROR);
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 8:
                _context6.next = 10;
                return this.changeEliotState(_CONSTANT2.default.ELIOT_STATE.CLOSE);
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                if (!(this.eliotState === _CONSTANT2.default.ELIOT_STATE.LAUNCHING)) {
                  _context7.next = 3;
                  break;
                }
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 5:
                  ...
                  _this2.makeTheMasterToQuitTheWholeApp();
    ...
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(_ref10) {
        var dataName = _ref10.dataName,
            data = _ref10.data,
            _ref10$timestamp = _ref10.timestamp,
            timestamp = _ref10$timestamp === undefined ? new Date() : _ref10$timestamp,
            _ref10$limitToTaskLis = _ref10.limitToTaskList,
            limitToTaskList = _ref10$limitToTaskLis === undefined ? false : _ref10$limitToTaskLis;

        var DATABASE_MAINTAINANCE, _CONSTANT$GENERIC_DAT, COLLECTION_CRUD, SCREEN_STATUS_NEWS, BREAKDOWN_PARAMETER_NEWS, role;

        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                DATABASE_MAINTAINANCE = _CONSTANT2.default.ELIOT_STATE.DATABASE_MAINTAINANCE;
                _CONSTANT$GENERIC_DAT = _CONSTANT2.default.GENERIC_DATA_NEWS, COLLECTION_CRUD = _CONSTANT$GENERIC_DAT.COLLECTION_CRUD, SCREEN_STATUS_NEWS = _CONSTANT$GENERIC_DAT.SCREEN_STATUS_NEWS, BREAKDOWN_PARAMETER_NEWS = _CONSTANT$GENERIC_DAT.BREAKDOWN_PARAMETER_NEWS;

                // If the eliotState is one of the specified and the message type one of the specified we do not send the message

                if (!(_Utils2.default.checkThatAtLeastOneElementOfArray1ExistInArray2([DATABASE_MAINTAINANCE], [this.eliotState]) && _Utils2.default.checkThatAtLeastOneElementOfArray1ExistInArray2([dataName], [COLLECTION_CRUD, SCREEN_STATUS_NEWS, BREAKDOWN_PARAMETER_NEWS]))) {
                  _context9.next = 4;
                  break;
                }
              ...
              case 6:
                role = _context9.sent;
                return _context9.abrupt('return', role.sendDataToEveryELIOTTaskWhereverItIs({
                  dataName: dataName,
                  data: data,
                  timestamp: timestamp,
                  limitToTaskList: limitToTaskList
                }));
      ...
      function sendDataToEveryELIOTTaskWhereverItIs(_x5) {
        return _ref9.apply(this, arguments);
      }

      return sendDataToEveryELIOTTaskWhereverItIs;
    }()
    ...
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(_ref12) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 7:
                ...
                this.errorHappened(_context10.t0);
      ...
      function spreadDataToEveryLocalTask(_x6) {
        ...
        return _regenerator2.default.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                _context13.next = 2;
                return this.roleHandler.getRole(_CONSTANT2.default.DEFAULT_ROLE.MASTER_ROLE.id);
