    ...
    value: function () {
      var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(_ref11) {
        var dataName = _ref11.dataName,
            ...
            timestamp = _ref11$timestamp === undefined ? new Date() : _ref11$timestamp,
            _ref11$limitToTaskLis = _ref11.limitToTaskList,
            limitToTaskList = _ref11$limitToTaskLis === undefined ? false : _ref11$limitToTaskLis;
        ...
        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                DATABASE_MAINTAINANCE = _CONSTANT2.default.DEFAULT_STATE.DATABASE_MAINTAINANCE;
                ...
                if (!(_Utils2.default.checkThatAtLeastOneElementOfArray1ExistInArray2([DATABASE_MAINTAINANCE.id], [this.eliotState.id]) && _Utils2.default.checkThatAtLeastOneElementOfArray1ExistInArray2([dataName], [COLLECTION_CRUD, SCREEN_STATUS_NEWS, BREAKDOWN_PARAMETER_NEWS]))) {
                  _context9.next = 4;
                  break;
                }
