      ...
      this.stateChangeCallbacks.forEach(function (_ref4) {
        ...
        (0, _setImmediate3.default)(function () {
          return callback(_this3.states.find(function (x) {
            return x.id === _this3.programState.id;
          }));
        }, 0);
      });
    }
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    elementToTreat = _this4.getProgramStateChangeToTreat();
                  ...
                  case 3:
                    ...
                    if (!(elementToTreat.programState.id === _this4.programState.id)) {
                      _context4.next = 7;
                      break;
                    }
                    ...
                    return _context4.abrupt('return', _this4.programChangeElementGotTreated(elementToTreat));

                  case 7:
                    oldProgramState = _this4.programState;


                    _this4.programState = elementToTreat.programState;
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            _this7.programStateChangeWaitingList.push({
              resolve: resolve,
              reject: reject,
              programState: _this7.states.find(function (x) {
                return x.id === idProgramState;
              }),
              inProgress: false
            });

            _this7.lookAtProgramStateChangePipe();
          });
        }
      });
    }
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 7:
                    _context7.prev = 7;
                    _context7.next = 10;
                    return _this9.changeProgramState(_CONSTANT2.default.DEFAULT_STATES.ERROR.id);
                  ...
                  case 14:
                    ...
                    RoleAndTask.exitProgramMsg('Exit program unproper ERROR HAPPENED', err, _context7.t0);
                  ...
                  case 20:
                    ...
                    RoleAndTask.exitProgramMsg('Exit program unproper ERROR HAPPENED CATCH', err, _context7.t1);
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 8:
                    _context8.next = 10;
                    return _this10.changeProgramState(_CONSTANT2.default.DEFAULT_STATES.CLOSE.id);
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    if (!(_this11.programState.id === _CONSTANT2.default.DEFAULT_STATES.LAUNCHING.id)) {
                      _context9.next = 3;
                      break;
                    }
