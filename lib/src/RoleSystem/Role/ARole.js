...
var ARole = function () {
  ...
  (0, _createClass3.default)(ARole, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new _Errors2.default('EXXXX', 'No taskHandler defined');
    ...
    value: function getTaskListStatus() {
      if (!this.taskHandler) return new _Errors2.default('EXXXX', 'No taskHandler defined');
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                throw new _Errors2.default('EXXXX', 'Unimplemented getInstance methods in ' + _Utils2.default.getFunctionName() + ' child');
