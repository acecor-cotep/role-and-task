...
var Master = /** @class */ (function (_super) {
    ...
    function Master() {
        ...
        _this.setTaskHandler(new TaskHandler_1.default(tasks.reduce(function (tmp, x) {
            tmp[x.name] = x;
            return tmp;
        }, {})));
     ...
     * Init the properties
     */
    Master.prototype.initProperties = function () {
        // Define none communicationSystem for now
    ...
    Master.prototype.getCommunicationSystem = function () {
     ...
     */
    Master.prototype.unlistenSlaveConnectionEvent = function (func) {
     ...
     */
    Master.prototype.unlistenSlaveDisconnectionEvent = function (func) {
     ...
     */
    Master.prototype.listenSlaveConnectionEvent = function (func, context) {
     ...
     */
    Master.prototype.listenSlaveDisconnectionEvent = function (func, context) {
        if (context === void 0) { context = this; }
    ...
    Master.prototype.getNonConfirmedSlaves = function () {
        return this.notConfirmedSlaves;
    };
    Master.prototype.getSlaves = function () {
        return this.slaves;
    };
    /**
     ...
     */
    Master.prototype.sendDataToEveryProgramTaskWhereverItIsLowLevel = function (_, __, body) {
        var _this = this;
     ...
     * We get asked to spread a news to every slave tasks and our tasks
     */
    Master.prototype.sendDataToEveryProgramTaskWhereverItIs = function (data) {
        this.sendDataToEveryProgramTaskWhereverItIsLowLevel([], '', data);
    };
    Master.prototype.tellMasterAboutSlaveError = function (clientIdentityString, err) {
    ...
    Master.prototype.errorHappenedIntoSlave = function (_, clientIdentityString, body) {
        var _this = this;
     ...
     */
    Master.prototype.takeMutex = function (id) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var customFunctions;
     ...
     */
    Master.prototype.releaseMutex = function (id) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var customFunctions;
     ...
     */
    Master.prototype.protocolTakeMutex = function (_, clientIdentityString, body) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Master.prototype.protocolReleaseMutex = function (_, clientIdentityString, body) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     * (Authentification)
     */
    Master.prototype.protocolMasterSlave = function () {
        var _this = this;
        // Shortcuts
        ...
        this.communicationSystem.listenClientDisconnectionEvent(function (clientIdentityString) {
            _this.slaves = _this.slaves.filter(function (x) {
                if (x.clientIdentityString === clientIdentityString) {
                    ...
                    Utils_1.default.fireUp(_this.newDisconnectionListeningFunction, [
                        x,
                    ]);
                    return false;
                }
        ...
        var confirmSlave = function (clientIdentityByte, clientIdentityString, dataJSON) {
            ...
            Utils_1.default.fireUp(_this.newConnectionListeningFunction, [
                slave,
            ]);
        };
     ...
     */
    Master.prototype.infosAboutSlaveIncomming = function (_, clientIdentityString, data) {
        // Get the right slave
        var slave = this.slaves.find(function (x) { return x.clientIdentityString === clientIdentityString; });
     ...
     */
    Master.prototype.getFullSystemPids = function () {
        var _this = this;
        return PromiseCommandPattern_1.default({
     ...
     */
    Master.prototype.connectMasterToTask = function (idTaskToConnectTo, idTaskToConnect, args) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     * Connect the second Task to the first one
     */
    Master.prototype.connectTaskToTask = function (identifierSlave, idTaskToConnectTo, idTaskToConnect, args) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var ret;
     ...
     */
    Master.prototype.modifyTaskStatusToSlaveLocalArray = function (identifier, idTask, status) {
        var _this = this;
     ...
     */
    Master.prototype.startTaskToSlave = function (identifier, idTask, args) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var ret;
    ...
    Master.prototype.listSlaves = function () {
        return this.getSlaves();
    };
    /**
     * List a slave tasks using its identifier (Ask the slave to it)
     */
    Master.prototype.distantListSlaveTask = function (identifier) {
        var _this = this;
        return PromiseCommandPattern_1.default({
     ...
     */
    Master.prototype.listSlaveTask = function (identifier) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var slave;
     ...
     */
    Master.prototype.handleProgramStateChange = function (programState, oldProgramState) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () {
     ...
     */
    Master.prototype.getSlavesOnlyThatAreRegularSlaves = function () {
     ...
     */
    Master.prototype.tellAllSlaveThatProgramStateChanged = function (programState, oldProgramState) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var regularSlaves;
    ...
    Master.prototype.tellASlaveThatProgramStateChanged = function (slaveIdentifier, programState, oldProgramState) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    Master.prototype.removeExistingSlave = function (identifiersSlaves) {
        var _this = this;
        return PromiseCommandPattern_1.default({
     ...
     */
    Master.prototype.killSlave = function (programIdentifier) {
        var _this = this;
     ...
     */
    Master.prototype.removeTaskFromSlave = function (identifier, idTask, args) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var STOP_TASK, ret;
     ...
     */
    Master.prototype.displayMessage = function (param) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Master.prototype.startNewSlaveInProcessMode = function (slaveOpts, _, connectionTimeout) {
        var _this = this;
        return PromiseCommandPattern_1.default({
     ...
     */
    Master.prototype.tellOneTaskAboutArchitectureChange = function (idTask) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Master.prototype.somethingChangedAboutSlavesOrI = function () {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
     ...
     */
    Master.prototype.startNewSlave = function (slaveOpts, specificOpts, connectionTimeout) {
        var _this = this;
     ...
     */
    Master.prototype.sendMessageToSlaveHeadBodyPattern = function (programIdentifier, headString, body) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var message;
     ...
     */
    Master.prototype.sendMessageToSlave = function (programIdentifier, message) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var slave;
     ...
     */
    Master.prototype.getSlaveByProgramIdentifier = function (programIdentifier) {
     ...
     */
    Master.prototype.getMessageFromSlave = function (headString, programIdentifier, timeout) {
        var _this = this;
     ...
     */
    Master.prototype.infiniteGetCpuAndMemory = function () {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
     ...
     */
    Master.prototype.infiniteGetTasksInfos = function () {
        var _this = this;
     ...
     * @override
     */
    Master.prototype.start = function (_a) {
        var _this = this;
     ...
     */
    Master.getHierarchyLevelByIdTask = function (computeListClosure, idTask) {
        var toRet;
     ...
     */
    Master.prototype.chooseWhichTaskToStop = function () {
        ...
        var computeListClosure = Master.sortArray(tasksMaster.map(function (x) { return ({
            idTask: x.id,
        ...
        var foundHighestInHierarchy = this.slaves.some(function (x) { return x.tasks.some(function (y) {
            ...
            var hierarchyY = Master.getHierarchyLevelByIdTask(computeListClosure, y.id);
            if (!y.isActive) {
                return false;
            }
        ...
        tasksMaster.some(function (x) {
            var hierarchyX = Master.getHierarchyLevelByIdTask(computeListClosure, x.id);
            if (!x.isActive) {
                return false;
            }
            // Look if this hierarchy is higher than the save one
     ...
     */
    Master.prototype.stopAllTaskOnEverySlaveAndMaster = function () {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Master.prototype.sendMessageAndWaitForTheResponse = function (_a) {
        var _this = this;
