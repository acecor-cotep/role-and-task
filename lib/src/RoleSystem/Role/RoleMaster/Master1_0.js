...
var Master1_0 = function (_AMaster) {
  ...
  (0, _createClass3.default)(Master1_0, [{
    ...
    value: function errorHappenedIntoSlave(clientIdentityByte, clientIdentityString) {
      var _this3 = this;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    ...
                    _this3.tellHandleEliotTaskAboutSlaveError(clientIdentityString, err);
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 9:
                    ...
                    _this6.sendMessageToSlaveHeadBodyPattern(slave.eliotIdentifier, TAKE_MUTEX, (0, _stringify2.default)({
                      error: false
                    }));
                    _context4.next = 16;
                    break;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 7:
                    ...
                    _this7.sendMessageToSlaveHeadBodyPattern(slave.eliotIdentifier, RELEASE_MUTEX, (0, _stringify2.default)({
                      error: false
                    }));
                    _context5.next = 14;
                    break;
    ...
    value: function protocolMasterSlave() {
      ...
      this.getCommunicationSystem().listenToIncomingMessage(function (clientIdentityByte, clientIdentityString, dataString) {
        ...
        [{
          ...
          applyFunc: function applyFunc() {
            return _this8.sendDataToEveryELIOTTaskWhereverItIsLowLevel(clientIdentityByte, clientIdentityString, dataJSON[BODY]);
          }
        }, {
          //
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    slave = _this16.getSlaveByEliotIdentifier(identifier);
    ...
    value: function handleEliotStateChange(eliotState, oldEliotState) {
      var _this17 = this;
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          ...
          // Spread to our tasks
          _this17.getTaskHandler().applyNewEliotState(eliotState, oldEliotState),

          // Spread to slaves
          _this17.tellAllSlaveThatEliotStateChanged(eliotState, oldEliotState)]
    ...
    value: function tellAllSlaveThatEliotStateChanged(eliotState, oldEliotState) {
      var _this18 = this;
                ...
                switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    return _context10.abrupt('return', _promise2.default.all(regularSlaves.map(function (x) {
                      return _this18.tellASlaveThatEliotStateChanged(x.eliotIdentifier, eliotState, oldEliotState);
                    })));
    ...
    value: function tellASlaveThatEliotStateChanged(slaveIdentifier, eliotState, oldEliotState) {
      var _this19 = this;
              ...
              while (1) {
                switch (_context11.prev = _context11.next) {
                  ...
                  case 6:
                    ...
                    _RoleAndTask2.default.getInstance().displayMessage({
                      str: ('[' + _this19.name + '] eliot state get not spread in Slave N\xB0' + slaveIdentifier).red
                    });
              ...
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    ...
                    if (!_this23.displayTask) {
                      _context13.next = 9;
                      break;
                    }

                    _context13.next = 4;
                    return _this23.getTaskHandler().getTask(_this23.displayTask);
                  ...
                  case 12:
                    ...
                    _Utils2.default.displayMessage({
                      str: String(_context13.t0.stack || _context13.t0),
                      out: process.stderr
                    });
    ...
    value: function sendMessageToSlaveHeadBodyPattern(eliotIdentifier, headString, bodyString) {
      var _this28 = this;
              ...
              while (1) {
                switch (_context17.prev = _context17.next) {
                  case 0:
                    ...
                    return _context17.abrupt('return', _this28.sendMessageToSlave(eliotIdentifier, (0, _stringify2.default)(message)));
    ...
    value: function sendMessageToSlave(eliotIdentifier, message) {
      var _this29 = this;
            ...
            return _regenerator2.default.wrap(function _callee18$(_context18) {
              while (1) {
                switch (_context18.prev = _context18.next) {
                  case 0:
                    // Look for the slave in confirmSlave
                    slave = _this29.getSlaveByEliotIdentifier(eliotIdentifier);
    ...
    value: function getSlaveByEliotIdentifier(eliotIdentifier) {
      ...
      return slave || new _Errors2.default('E7004', 'Identifier: ' + eliotIdentifier);
    }
      ...
      return new _PromiseCommandPattern2.default({
        func: function func() {
          return new _promise2.default(function (resolve, reject) {
            ...
            // Look for the slave in confirmSlave
            var slave = _this30.getSlaveByEliotIdentifier(eliotIdentifier);
