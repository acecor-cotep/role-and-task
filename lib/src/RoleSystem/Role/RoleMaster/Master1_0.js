...
var ZeroMQServerRouter_1 = __importDefault(require("../../../CommunicationSystem/SocketCommunicationSystem/ZeroMQ/Server/ZeroMQServerRouter"));
var instance = null;
/**
...
var Master1_0 = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (RoleAndTask_1.default.getInstance().makesErrorFatal) {
    ...
    Master1_0.prototype.protocolMasterSlave = function () {
        ...
        this.communicationSystem.listenClientConnectionEvent(function (clientIdentityByte, clientIdentityString) {
            ...
            return _this.communicationSystem.sendMessage(clientIdentityByte, clientIdentityString, SLAVE_CONFIRMATION_INFORMATIONS);
        });
        ...
        this.slaves.some(function (x, xi) {
            if (x.programIdentifier === identifier) {
                return x.tasks.some(function (y, yi) {
                    if (y.id === idTask) {
                        _this.slaves[xi].tasks[yi].isActive = status;
                        return true;
                    }
                    return false;
                });
    ...
    Master1_0.prototype.getSlavesOnlyThatAreRegularSlaves = function () {
        return this.slaves.filter(function (x) { return x.role.id === CONSTANT_1.default.DEFAULT_ROLES.SLAVE_ROLE.id; });
    };
    /**
            ...
            func: function () { return new Promise(function (resolve, reject) {
                ...
                var connectEvent = function (slaveInfos) {
                    ...
                    if (slaveInfos && slaveInfos.programIdentifier === uniqueSlaveId) {
                        ...
                        return resolve(__assign(__assign({}, slaveInfos), { pid: slaveInfos.clientPID }));
                    }
     ...
     */
    Master1_0.prototype.sendMessageToSlaveHeadBodyPattern = function (programIdentifier, headString, bodyString) {
        var _this = this;
        return PromiseCommandPattern_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                var message;
                ...
                return __generator(this, function (_b) {
                    message = (_a = {},
                        ...
                        _a[CONSTANT_1.default.PROTOCOL_KEYWORDS.BODY] = bodyString,
                        _a);
                    // Send the message
