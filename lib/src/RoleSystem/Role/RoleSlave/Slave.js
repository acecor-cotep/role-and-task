...
var Slave = /** @class */ (function (_super) {
     ...
     */
    function Slave(oneshotNewInstance) {
        ...
        _this.setTaskHandler(new TaskHandler_js_1.default(tasks.reduce(function (tmp, x) {
            tmp[x.name] = x;
            return tmp;
        }, {})));
    ...
    Slave.getInstance = function () {
        return instance || new Slave();
    };
    Slave.prototype.getCommunicationSystem = function () {
        return this.communicationSystem;
    };
    /**
     * Display a message by giving it to the master
     */
    Slave.prototype.displayMessage = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // If we disallow log display, stop it here
                if (!RoleAndTask_js_1.default.getInstance().displayLog) {
                    return [2 /*return*/];
                }
    ...
    Slave.prototype.sendTaskList = function () {
     ...
     */
    Slave.prototype.sendConfirmationInformations = function () {
        var handler = this.getTaskHandler();
        if (handler === false) {
            throw new Errors_js_1.default('EXXXX', 'no task handler');
        }
     ...
     */
    Slave.prototype.sendDataToEveryProgramTaskWhereverItIs = function (data) {
    ...
    Slave.prototype.sendHeadBodyMessageToServer = function (head, body) {
    ...
    Slave.prototype.protocolStartTask = function (body) {
        var _this = this;
    ...
    Slave.prototype.protocolStopTask = function (body) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Slave.prototype.protocolSendMyInfosToMaster = function (_a) {
        var _this = this;
     ...
     */
    Slave.prototype.protocolConnectTasks = function (body) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            task = _b.sent();
                            if (!!task.isActive()) return [3 /*break*/, 3];
                            this.sendHeadBodyMessageToServer(START_TASK, new Errors_js_1.default('E7009', "idTask: " + body.idTask));
                            return [3 /*break*/, 5];
                        case 3: 
     ...
     */
    Slave.protocolGenericChannelData = function (body) {
        // For itself tasks
     ...
     */
    Slave.prototype.protocolStateChange = function (body) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Slave.prototype.tellMasterErrorHappened = function (err) {
     ...
     */
    Slave.prototype.takeMutex = function (id) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Slave.prototype.releaseMutex = function (id) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
     ...
     */
    Slave.prototype.protocolMasterSlave = function () {
        var _this = this;
        var communication = this.getCommunicationSystem();
        if (communication === false) {
            throw new Errors_js_1.default('EXXXX', 'no communication');
        ...
        communication.listenToIncomingMessage(function (dataString) {
            ...
            [
                ...
                // Check about news about generic channel data
                {
                    ...
                    applyFunc: function () { return Slave.protocolGenericChannelData(dataJSON[BODY]); },
                },
     ...
     */
    Slave.prototype.infiniteSendCpuAndMemoryLoadToMaster = function () {
        var _this = this;
     ...
     * Send the cpu and memory load to the server periodically
     */
    Slave.prototype.infiniteSendTasksInfosToMaster = function () {
        var _this = this;
     ...
     * Start the Slave
     */
    Slave.prototype.startSlave = function (_a) {
        var _this = this;
    ...
    Slave.prototype.start = function (args) {
        var _this = this;
        return PromiseCommandPattern_js_1.default({
            func: function () { return _this.startSlave(args); },
        });
    };
     ...
     */
    Slave.prototype.sendMessageToServer = function (data) {
        var communication = this.getCommunicationSystem();
        if (communication === false) {
            throw new Errors_js_1.default('EXXXX', 'no communication');
        }
     ...
     */
    Slave.prototype.getMessageFromServer = function (headString, timeout) {
        var _this = this;
     ...
     * @param {Object} args
     */
    Slave.prototype.sendMessageAndWaitForTheResponse = function (_a) {
        var _this = this;
        ...
        return PromiseCommandPattern_js_1.default({
            func: function () { return new Promise(function (resolve, reject) {
                ...
                return _this.sendMessageToServer(messageBodyToSend);
