...
var Slave1_0 = function (_ASlave) {
  ...
  (0, _createClass3.default)(Slave1_0, [{
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                _context5.prev = 3;
                _context5.next = 6;
                return _RoleAndTask2.default.getInstance().changeEliotState(body.eliotState.id);
    ...
    key: 'releaseMutex',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(id) {
    ...
    value: function () {
      ...
      function askForDatabaseConnectionChange(_x9) {
    ...
    value: function () {
      ...
      function protocolDatabaseConnectionChange(_x10) {
