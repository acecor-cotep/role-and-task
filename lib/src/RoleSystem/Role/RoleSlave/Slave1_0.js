...
var Slave1_0 = function (_ASlave) {
  ...
  (0, _createClass3.default)(Slave1_0, [{
    ...
    value: function displayMessage(params) {
      ...
      if (!_RoleAndTask2.default.getInstance().displayLog) return;
    ...
    value: function getMessageFromServer(headString) {
      ...
      var timeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _RoleAndTask2.default.getInstance().masterMessageWaitingTimeout;
