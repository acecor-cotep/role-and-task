...
var Slave1_0 = /** @class */ (function (_super) {
            ...
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            err_1 = _a.sent();
                            this.sendHeadBodyMessageToServer(START_TASK, err_1.serialize());
                            return [3 /*break*/, 4];
            ...
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            err_2 = _a.sent();
                            this.sendHeadBodyMessageToServer(STOP_TASK, err_2.serialize());
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/, false];
                    }
                });
            ...
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            err_3 = _a.sent();
                            infos.cpuAndMemory = err_3.serialize();
                            this.sendHeadBodyMessageToServer(INFOS_ABOUT_SLAVES, infos);
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/, false];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            this.sendHeadBodyMessageToServer(STATE_CHANGE, err_5.serialize());
                            return [3 /*break*/, 5];
    ...
    Slave1_0.prototype.startSlave1_0 = function (_a) {
        var _this = this;
        var _b = _a.ipServer, ipServer = _b === void 0 ? CONSTANT_js_1.default.ZERO_MQ.DEFAULT_SERVER_IP_ADDRESS : _b, _c = _a.portServer, portServer = _c === void 0 ? CONSTANT_js_1.default.ZERO_MQ.DEFAULT_SERVER_IP_PORT : _c, identifier = _a.identifier;
        return PromiseCommandPattern_js_1.default({
            func: function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
     ...
     * @param {String} data
     */
    Slave1_0.prototype.sendMessageToServer = function (data) {
        var communication = this.getCommunicationSystem();
        if (communication === false)
            throw new Errors_js_1.default('EXXXX', 'no communication');
