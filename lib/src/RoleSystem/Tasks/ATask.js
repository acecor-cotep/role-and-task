...
var ATask = function () {
  ...
  (0, _createClass3.default)(ATask, [{
    ...
    value: function connectToTask() {
      return new _promise2.default(function (_, reject) {
        return reject(new Error('Unimplemented connectToTask methods in ' + _Utils2.default.getFunctionName() + ' child'));
      });
    }
    ...
    value: function applyNewEliotState() {
      return new _promise2.default(function (resolve) {
        return resolve();
      });
    }
    ...
    value: function getInstance() {
      return new _promise2.default(function (_, reject) {
        return reject(new Error('Unimplemented getInstance methods in ' + _Utils2.default.getFunctionName() + ' child'));
      });
    }
  }, {
    key: 'name',
