...
exports.default = function (superclass) {
  return function (_superclass) {
    ...
    (0, _createClass3.default)(CONSTANT, null, [{
      ...
      key: 'CONSOLE_SIZE_OF_REGULAR_LINE',
      get: function get() {
        return CONSTANT.getInstance().consoleSizeOfStandardLine || 75;
      }
      ...
      key: 'CONSOLE_REGULAR_LINE',
      get: function get() {
        // Use a tricks to only calcul it once
        if (!CONSTANT.getInstance().storeStaticRegularLine) {
          CONSTANT.getInstance().storeStaticRegularLine = _Utils2.default.generateStringFromSameChar(CONSTANT.CONSOLE_SEPARATOR_CHAR, CONSTANT.CONSOLE_SIZE_OF_REGULAR_LINE) + '\n';
        }

        return CONSTANT.getInstance().storeStaticRegularLine;
      }
      ...
      key: 'CONSOLE_VALID_COLORS',
      get: function get() {
        return ['black', 'red', 'green', 'yellow', 'blue', 'magenta', 'cyan', 'white', 'gray', 'grey'];
      }
      ...
      key: 'CONSOLE_MAJOR_COLOR',
      get: function get() {
        return _colors2.default.blue;
      }
      ...
      key: 'CONSOLE_MINOR_COLOR',
      get: function get() {
        return _colors2.default.grey;
      }
      ...
      key: 'CONSOLE_SPECIAL_COLOR',
      get: function get() {
        return _colors2.default.cyan.bold;
      }
    }]);
    return CONSTANT;
  }(superclass);
