...
var Utils = function () {
  ...
  (0, _createClass3.default)(Utils, null, [{
    ...
    value: function () {
      ...
      function recursiveCallFunction(_x2) {
    ...
    value: function execCommandLine(cmd) {
      ...
      return new _promise2.default(function (resolve, reject) {
        _child_process2.default.exec(cmd, options, function (err, res) {
          if (err) {
            return reject(new _Errors2.default('E8191', '' + String(err)));
          }
    ...
    value: function execStreamedCommandLine(_ref4) {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        ls.on('error', function (err) {
          ...
          reject(new _Errors2.default('E8200', '' + err.toString()));
        });
      });
    }
    ...
    value: function displayMessage(_ref5) {
      var str = _ref5.str,
          ...
          from = _ref5$from === undefined ? process.pid : _ref5$from,
    ...
    value: function readFile(filename) {
      ...
      return new _promise2.default(function (resolve, reject) {
        _fs2.default.readFile(filename, options, function (err, data) {
          if (err) return reject(new _Errors2.default('E8088', 'filename: ' + filename, String(err)));
    ...
    value: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                throw new _Errors2.default('E8089', '' + String(_context2.t0));
      ...
      function parseHjsonContent(_x5) {
    ...
    value: function () {
      ...
      function executePromiseCallUntilTrue(_x6) {
    ...
    value: function () {
      ...
      function promiseCallUntilTrue(_x7) {
    ...
    value: function () {
      ...
      function executePromiseQueue(_x8) {
