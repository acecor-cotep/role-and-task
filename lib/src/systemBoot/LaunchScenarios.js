...
var LaunchScenarios = function () {
  ...
  (0, _createClass3.default)(LaunchScenarios, [{
    ...
    value: function getMapLaunchingModes() {
      return [{
        name: _CONSTANT2.default.PROGRAM_LAUNCHING_MODE.MASTER,
        func: this.master
      }, {
        name: _CONSTANT2.default.PROGRAM_LAUNCHING_MODE.SLAVE,
        func: this.slave
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 8:
                    _context.next = 10;
                    return _RoleAndTask2.default.getInstance().changeProgramState(_CONSTANT2.default.DEFAULT_STATES.READY_PROCESS.id);
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 5;
                    return LaunchScenarios.parseEqualsArrayOptions(options, _CONSTANT2.default.PROGRAM_LAUNCHING_PARAMETERS.MODE_OPTIONS.name);
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    throw new _Errors2.default('INVALID_LAUNCHING_PARAMETER', 'Parameter: ' + name);
