...
// Get the options
var options = Library_1.default.extractOptionsFromCommandLineArgs();
// We have something like mode-options = ['optA=12', 'optB=78', ...]
var modeoptions = Library_1.default.parseEqualsArrayOptions(options, Library_1.default.CONSTANT.PROGRAM_LAUNCHING_PARAMETERS.MODE_OPTIONS.name);
