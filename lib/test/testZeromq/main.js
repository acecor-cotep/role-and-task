...
var ServerTask_1 = __importDefault(require("./ServerTask"));
var ClientTask_1 = __importDefault(require("./ClientTask"));
...
roleAndTask.declareTask({
    ...
    // The task object
    obj: ServerTask_1.default.getInstance(),
});
roleAndTask.declareTask({
    name: 'ClientTask',
    // Name of the task in the configuration file
    ...
    // The task object
    obj: ClientTask_1.default.getInstance(),
});
...
roleAndTask.setConfiguration({
    ...
    launchMasterSlaveConfigurationFile: path_1.default.resolve(__dirname) + "/../../../test/testZeromq/minimalArchitecture.hjson",
