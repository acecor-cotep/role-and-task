...
roleAndTask.setConfiguration({
  ...
  launchMasterSlaveConfigurationFile: `${path.resolve(__dirname)}/../../../test/testZeromq/minimalArchitecture.hjson`,
